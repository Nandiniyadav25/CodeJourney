...
import flat1 from "../../assets/roomhouse2.avif";
...
const Home = () => {
  ...
  return (
    <div id='home'>
      <Card image1={house} image2={house1} image3={house2} title={"3BHK Villa in Jhansi"} price={"20,000"}/>
      <Card image1={farmhouse} image2={farmhouse1} image3={farmhouse2} title={"Farmhouse in Lucknow"} price={"60,000"}/>
      <Card image1={flat} image2={flat1} image3={flat2} title={"1BHK flat in Manali"} price={"60,000"}/>
      <Card image1={villa2} image2={villa1} image3={villa} title={" Modern House in Jaipur"} price={"30,000"}/>
      <Card image1={mountain} image2={mountain1} image3={mountain2} title={"Mountain side House"} price={"20,000"}/>
      <Card image1={huthouse} image2={huthouse1} image3={huthouse2} title={"Hut House"} price={"20,000"}/>
      <Card image1={village} image2={village1} image3={village2} title={"Village Home"} price={"20,000"}/>
      <Card image1={room} image2={room1} image3={room2} title={"Luxary Bedroom"} price={"20,000"}/>
      <Card image1={old} image2={old1} image3={old2} title={"1BHK house in Manali"} price={"20,000"}/>
      <Card image1={roomnew} image2={roomnew1} image3={roomnew2} title={"3BHK Villa in Jhansi"} price={"20,000"}/>
      <Card image1={hut3} image2={hut2} image3={hut1} title={"Hut House"} price={"20,000"}/>
      <Card image1={ski} image2={ski1} image3={ski2} title={"3BHK Villa in Jhansi"} price={"40,000"}/>
